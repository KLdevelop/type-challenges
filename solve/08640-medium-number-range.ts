...
type UnionToNumber<T extends string> = T extends string ? ParseInt<T> : T

type FullNumberRange<N extends number> =
  0 | UnionToNumber<Extract<Exclude<keyof ConstructTuple<N>, keyof []>, string>> | N

type NumberRange<L extends number, H extends number> =
  L | Exclude<FullNumberRange<H>, FullNumberRange<L>>
